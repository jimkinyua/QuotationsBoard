...
namespace Quotations_Board_Backend.Migrations
{
    ...
    [Migration("20231124121234_InstitutionApplication")]
    partial class InstitutionApplication
    {
            ...
            modelBuilder.Entity("PortalUser", b =>
                {
                    ...
                    b.Property<string>("AdministationEmail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AdministationName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AdministrationPhoneNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
